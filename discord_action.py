...
def main():
    ...
    try:
        ...
        if MODE == "sbi_tdnet_event_test":
            from tdnet import create_tdnet_event_test_embed, run_tdnet_event_test

            result = run_tdnet_event_test(days=7)
            send_discord_embed(create_tdnet_event_test_embed(result))
            return
